...
namespace VostokVR.Geo {
    ...
    /// <summary>
    /// Shows confirming dialog window for any Geo App action.
    /// </summary>
    public class CanvasDialogGeoLoadScene : CanvasDialog {

        public static new CanvasDialogGeoLoadScene Instance { get; private set; }
